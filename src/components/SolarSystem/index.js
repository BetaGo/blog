...
const sun = '40px';
const mercuryOrb  = '70px'; const mercuryPl = '4px'; 
const venusOrb  = '100px'; const venusPl = '8px'; 
const earthOrb  = '145px'; const earthPl = '6px'; 
const marsOrb  = '190px'; const marsPl = '6px';
const jupiterOrb  = '340px'; const jupiterPl = '18px'; 
const saturnOrb  = '440px'; const saturnPl = '12px';
const uranusOrb  = '520px'; const uranusPl = '10px';
const neptuneOrb  = '630px'; const neptunePl = '10px';
const plutoOrb  = '780px'; const plutoPl = '3px';

const asteroidsBeltOrb = '300px'; const asteroidsBeltPl = '210px';
...
const createStars = (count, maxArea, minArea = 0, starSize = 0) => {
    const star = () => `${minArea + Math.floor(Math.random() * maxArea)}px ${minArea + Math.floor(Math.random() * maxArea)}px 0 ${starSize}px rgba(255, 255, 255, ${Math.random().toFixed(2)}),`
    let str = ''
